...
<body>
    <div class="addroomsection">
        <form action="" method="POST">
            <label for="troom">Nume :</label>
            <input type="text" name="staffname" class="form-control">

            <label for="bed">Slujba :</label>
            ...
            <button type="submit" class="btn btn-success" name="addstaff">Adauga Angajat</button>
        </form>
        ...
        while ($row = mysqli_fetch_array($re)) {
                echo "<div class='roombox'>
						<div class='text-center no-boder'>
                            ...
                            <a href='staffdelete.php?id=". $row['id'] ."'><button class='btn btn-danger'>Șterge</button></a>
						</div>
                    </div>";
        }
        ?>
