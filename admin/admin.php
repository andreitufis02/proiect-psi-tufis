...
<body>
    ...
    <nav class="uppernav">
        <div class="logo">
            <img class="bluebirdlogo" src="../image/3.png" alt="logo">
            <p>HOTEL AURORA - DASHBOARD</p>
        </div>
        <div class="logout">
        <a href="../logout.php"><button class="btn btn-primary">Delogare</button></a>
        </div>
    </nav>
    <nav class="sidenav">
        <ul>
            <li class="pagebtn active"><img src="../image/icon/dashboard.png">&nbsp&nbsp&nbsp Dashboard</li>
            <li class="pagebtn"><img src="../image/icon/bed.png">&nbsp&nbsp&nbsp Rezervare camere</li>
            <li class="pagebtn"><img src="../image/icon/wallet.png">&nbsp&nbsp&nbsp Plati</li>
            <li class="pagebtn"><img src="../image/icon/bedroom.png">&nbsp&nbsp&nbsp Camere</li>
