        ...
        <table class="table table-bordered" id="table-data">
            <thead>
                <tr>
                    ...
                    <th scope="col">Cost/pat</th>
                    <th scope="col">Mese</th>
					<th scope="col">Total factură</th>
            ...
            ?>
                <tr>
                    ...
                    <td class="action">
                        <a href="invoiceprint.php?id= <?php echo $res['id']?>"><button class="btn btn-primary"><i class="fa-solid fa-print"></i>Printare</button></a>
						<a href="paymantdelete.php?id=<?php echo $res['id']?>"><button class="btn btn-danger">Ștergere</button></a>
                    </td>
                </tr>
            <?php
            }
