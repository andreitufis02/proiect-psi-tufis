...
<body>
    <div class="addroomsection">
        <form action="" method="POST">
            <label for="troom">Tip de cameră:</label>
            ...
            <label for="bed">Tip de pat:</label>
            ...
            <button type="submit" class="btn btn-success" name="addroom">Adaugă</button>
        </form>
            ...
            if ($id == "Superior Room") {
                echo "<div class='roombox roomboxsuperior'>
						<div class='text-center no-boder'>
                            ...
                            <a href='roomdelete.php?id=". $row['id'] ."'><button class='btn btn-danger'>Șterge</button></a>
						</div>
                    </div>";
