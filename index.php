...
<body>
    ...
    <section id="auth_section">
        ...
        <div class="logo">
            <img class="bluebirdlogo" src="./image/1.png" alt="logo">
            <p>AURORA</p>
        </div>
        ...
        <div class="auth_container">
            ...
            <div id="Log_in">
                ...
                <form class="user_login authsection active" id="userlogin" action="" method="POST">
                    ...
                    <button type="submit" name="user_login_submit" class="auth_btn">Logare</button>

                    <div class="footer_line">
                        <h6>Nu aveți cont? <span class="page_move_btn" onclick="signuppage()">Înregistrați-vă!</span></h6>
                    </div>
                </form>
                ...
                <form class="employee_login authsection" id="employeelogin" action="" method="POST">
                    ...
                    <div class="form-floating">
                        ...
                        <label for="floatingPassword">Parolă</label>
                    </div>
                    <button type="submit" name="Emp_login_submit" class="auth_btn">Loghează-te</button>
                </form>
